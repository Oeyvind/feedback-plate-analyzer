...
# kludge of an import of colormap into mayavi ...
from matplotlib import cm
import colorcet as cc
cmapname="cet_CET_R1_r"
_cmap = cm.get_cmap(cmapname)
cmap_arr= _cmap(range(256))
c.module_manager.scalar_lut_manager.lut.table = (cmap_arr*255).astype(int)
